<template>
  <div>
    <H1>ThreeBuffergeometry Hello World.</H1>
  </div>
</template>
  ...
  export default {
    ...
    mounted: function () {
      ...
      function init () {
        ...
        geometry.setAttribute('position', new Float32BufferAttribute(positions, 3).onUpload(disposeArray))
        geometry.setAttribute('normal', new Float32BufferAttribute(normals, 3).onUpload(disposeArray))
        geometry.setAttribute('color', new Float32BufferAttribute(colors, 3).onUpload(disposeArray))
